  ...
  return (
    <div className="min-h-screen bg-bg-primary">
      ...
      <header className="bg-bg-header/80 backdrop-blur-md border-b border-bg-tertiary/50 sticky top-0 z-50 shadow-2xl">
        <div className="px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            {/* Seletor de Período e Faturamento */}
      ...
      <main className="p-6 space-y-8 pt-8">
        ...
        {chartLoading ? (
          <div className="bg-bg-card p-8 shadow-2xl">
            <LoadingSpinner />
          </div>
        ) : (
          <div className="bg-bg-card p-6 shadow-2xl hover:shadow-3xl transition-all duration-300">
